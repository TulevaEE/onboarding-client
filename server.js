...
app.get(
  '/.well-known/acme-challenge/dhbqek29xJDgFahgnugaYDQCTxtOTjgi4FbNkhRgZfA',
  (request, response) =>
    response.send(
      'dhbqek29xJDgFahgnugaYDQCTxtOTjgi4FbNkhRgZfA.EMEBBxvSam3n_ien1J0z4dXeTuc2JuR3HqfAP6teLjE',
    ),
);
