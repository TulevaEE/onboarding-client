...
describe('Application section', () => {
  ...
  it('does not render at all when no pending applications are found', async () => {
    ...
    expect(screen.queryByText('Pending applications and transactions')).not.toBeInTheDocument();
  });
  ...
  it('renders correct fields for savings fund payment application', async () => {
    ...
    expect(await screen.findByText('deposit to Additional Investment Fund')).toBeInTheDocument();
  ...
  it('renders savings fund withdrawal application successfully', async () => {
    ...
    expect(await screen.findByText('Additional Investment Fund withdrawal')).toBeInTheDocument();
