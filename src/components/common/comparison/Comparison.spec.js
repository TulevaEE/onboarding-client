...
describe('Comparison', () => {
  ...
  it('if comparison is present, render table values', () => {
    ...
    expect(component.contains(<Message>comparison.output.calculation.first.row</Message>)).not.toBe(
      true,
    );
    expect(
      component.contains(
    ...
    expect(
      component.contains(<Message>comparison.output.calculation.second.row</Message>),
    ).not.toBe(true);
    component.setProps({ comparison: {} });
    expect(component.contains(<Message>comparison.output.calculation.first.row</Message>)).toBe(
      true,
    );
    expect(
      component.contains(
    ...
    expect(component.contains(<Message>comparison.output.calculation.second.row</Message>)).toBe(
      true,
    );
  });
  ...
  it('renders comaprison footnotes', () => {
    expect(component.contains(<ComparisonFootnotes />)).toBe(true);
  });
});
