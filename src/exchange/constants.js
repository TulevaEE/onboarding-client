...
export const GET_CONTRIBUTIONS_FUNDS_START = withPrefix('GET_CONTRIBUTIONS_FUNDS_START');
export const GET_CONTRIBUTIONS_FUNDS_SUCCESS = withPrefix('GET_CONTRIBUTIONS_FUNDS_SUCCESS');
export const GET_CONTRIBUTIONS_FUNDS_ERROR = withPrefix('GET_CONTRIBUTIONS_FUNDS_ERROR');
