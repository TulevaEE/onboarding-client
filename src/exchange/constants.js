...
export const SIGN_MANDATE_MOBILE_ID_START_ERROR = withPrefix('SIGN_MANDATE_MOBILE_ID_START_ERROR');
export const SIGN_MANDATE_INVALID_ERROR = withPrefix('SIGN_MANDATE_INVALID_ERROR');
export const SIGN_MANDATE_MOBILE_ID_SUCCESS = withPrefix('SIGN_MANDATE_MOBILE_ID_SUCCESS');
export const SIGN_MANDATE_MOBILE_ID_ERROR = withPrefix('SIGN_MANDATE_MOBILE_ID_ERROR');
...
export const SIGN_MANDATE_ID_CARD_START_ERROR = withPrefix('SIGN_MANDATE_ID_CARD_START_ERROR');
